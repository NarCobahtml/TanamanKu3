...
export const forumCategoryStats: ForumCategoryStat[] = [
  { name: 'Hama & Masalah Perawatan', postsCount: 2180, percentage: 40, color: 'bg-emerald-600' },
  { name: 'Tips & Panduan Tumbuh', postsCount: 1620, percentage: 30, color: 'bg-primary' },
  { name: 'Nutrisi, Tanah & Pupuk', postsCount: 980, percentage: 18, color: 'bg-amber-500' },
  { name: 'Diskusi Umum & Komunitas', postsCount: 640, percentage: 12, color: 'bg-blue-500' },
];
...
export const initialModeration: ModerationItem[] = [
  {
    ...
    snippet: 'Promo terbatas bibit anggrek hutan asli gratis ongkir seluruh Indonesia chat wa 08129999xxxx diskon gila-gilaan...',
  ...
  },
  {
    ...
    snippet: 'Ada tetangga yang bilang pemutih baju bisa membunuh semua jamur di pot, apakah benar aman untuk tanaman?',
    status: 'Perlu Tindakan',
  },
  {
    id: 'MOD-103',
    ...
    snippet: 'Saya pakai obat yang dilarang pemerintah ini hasilnya tokcer banget sekali semprot mati semua...',
    status: 'Diselesaikan',
  },
  {
    id: 'MOD-104',
    ...
    snippet: 'Mau tanya rekomendasi watt lampu grow light untuk tanaman indoor di kamar tanpa jendela...',
    status: 'Diabaikan',
  },
];
