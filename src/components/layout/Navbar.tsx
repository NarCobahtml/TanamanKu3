...
function NavIcon({ name, active }: { name: string; active: boolean }) {
  ...
  const path =
    name === "/home"
      ...
      : name === "/scan"
        ? "M4 7V5a1 1 0 0 1 1-1h2m10 0h2a1 1 0 0 1 1 1v2m0 10v2a1 1 0 0 1-1 1h-2M7 19H5a1 1 0 0 1-1-1v-2m4-5h8"
        : name === "/forum"
          ? "M8 10h8m-8 4h5m-8 6 2-4h12a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v13Z"
