...
## Corpus Check
- 154 files · ~185,153 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1516 nodes · 1743 edges · 116 communities (109 shown, 7 thin omitted)
...
- `TanamanCell()` --calls--> `cn()`  [EXTRACTED]
  src/components/TanamanPage.tsx → src/lib/utils.ts
...
### Community 2 - "TanamanDetailPage.tsx"
Cohesion: 0.12
Nodes (16): navItems, notifPrefs, HARI, HARI_1, isWaterDay(), riwayatKesehatan, TanamanDetailPage(), tanamanList (+8 more)

### Community 3 - "Navbar.tsx"
Cohesion: 0.06
Nodes (31): Home(), menuItems, filters, Scan, scans, ScanStatus, statusVisual, treatments (+23 more)

### Community 4 - "dependencies"
Cohesion: 0.06
Nodes (33): class-variance-authority, clsx, cn, lucide-react, next, next-themes, dependencies, class-variance-authority (+25 more)
...
Cohesion: 0.17
Nodes (7): steps, AuthForm(), perks, Button(), buttonVariants, Checkbox(), Skeleton()
...
### Community 42 - "CreatePostPage.tsx"
Cohesion: 0.16
Nodes (9): categories, Badge(), badgeVariants, Select(), SelectContent(), SelectItem(), SelectTrigger(), SelectValue() (+1 more)
...
Cohesion: 0.21
Nodes (9): categories, ExpertBadge(), ForumPost, forumPosts, topics, TkRevealClient(), Avatar(), AvatarFallback() (+1 more)

### Community 51 - "TanamanPage.tsx"
Cohesion: 0.16
Nodes (15): healthLevel(), jenisList, Kategori, kategoriList, PlantThumb(), StatusSiram, statusSiramBadge, Tanaman (+7 more)
...
### Community 59 - "cn"
Cohesion: 0.25
Nodes (8): EmptyState(), PageBand(), PageHeader(), SectionHeader(), preventions, symptoms, treatments, cn()
...
## Knowledge Gaps
- **965 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+960 more)
...
- **Why does `TkRevealClient()` connect `ForumPage.tsx` to `app/page.tsx`, `RiwayatPage.tsx`, `TanamanDetailPage.tsx`, `button.tsx`, `CreatePostPage.tsx`, `TanamanPage.tsx`, `cn`?**
...
- **Should `TanamanDetailPage.tsx` be split into smaller, more focused modules?**
